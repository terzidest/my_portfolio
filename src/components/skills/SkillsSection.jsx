      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Specialized in modern app Development with cutting-edge technologies.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="bg-blue-50 border-2 border-blue-100 rounded-lg p-6">
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h4 className="text-lg font-bold text-gray-900">React Native Specialization by Meta</h4>
                  <p className="text-gray-600 mb-2">Official Meta certification for React Native development</p>
                  <a 
            ...
            <div className="bg-blue-50 border-2 border-blue-100 rounded-lg p-6">
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h4 className="text-lg font-bold text-gray-900">JavaScript Algorithms and Data Structures</h4>
                  <p className="text-gray-600 mb-2">freeCodeCamp certification for advanced JavaScript</p>
                  <a 
