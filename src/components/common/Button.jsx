...
const Button = ({
  ...
  const variants = {
    ...
    secondary:
      "bg-white text-primary border border-primary hover:bg-gray-50 focus:ring-blue-500",
    outline:
      "bg-transparent text-primary border border-primary hover:bg-blue-50 focus:ring-blue-500",
