...
const ExperienceSection = () => {
  return (
    <section className="mt-16">
      ...
      <div className="relative ml-2 md:ml-3 border-l-2 border-gray-200 pl-8 md:pl-10 space-y-8">
        {experiences.map((exp, expIndex) => (
          <Reveal key={`${exp.company}-${exp.title}`} delay={expIndex * 100}>
            <div className="relative">
              {/* Dot sits on the rail. */}
              <span className="absolute -left-[41px] md:-left-[49px] top-1.5 w-4 h-4 rounded-full bg-primary ring-4 ring-blue-100"></span>
