        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/3 lg:pl-12">
            ...
            <p className="text-gray-600 text-lg mb-6">
              I'm a creative Developer with a strong background in building and
              implementing functional, high-quality apps . I specialize in
              development using React, React Native and Firebase, allowing me to
              efficiently create cross-platform apps for iOS, Android and the
              web.
            </p>

            <p className="text-gray-600 text-lg mb-6">
              I'm a fast learner, adaptable to new technologies, and always
              focused on delivering solutions with a keen eye for detail. I
              believe in creating applications that not only look great but also
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">
                    Clean, reusable components for scalable solutions
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="text-gray-600">
                    Secure authentications and integrations with APIs
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
