...
export const projects = [
  {
    ...
    title: "Little Lemon",
    description:
      "A mobile app fetching data from firebase and filtering effectively.",
  ...
  },
  {
    ...
    description:
      "A cross-platform e-commerce solution with shared Firebase backend for web and mobile.",
  ...
  },
  {
    ...
    description:
      "This responsive portfolio website showcasing my projects and skills as a developer.",
