...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: projectImage('ethnature.png', 600, 324, [320, 600], 'EtherealNature storefront home page', CARD_SIZES),
    additionalImages: [
      projectImage('ethnature.png', 600, 324, [320, 600], 'EtherealNature storefront home page'),
      projectImage('ethnature2.png', 602, 324, [320, 602], 'EtherealNature product catalog'),
      projectImage('ethnature3.png', 608, 324, [320, 608], 'EtherealNature shopping cart'),
    ],
  ...
  },
  {
    ...
    image: projectImage('portfolio.png', 559, 324, [320, 559], 'Portfolio home page', CARD_SIZES),
    additionalImages: [
