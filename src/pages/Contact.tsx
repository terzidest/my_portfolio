        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-1 space-y-6">
              <div className="bg-white dark:bg-slate-800 dark:ring-1 dark:ring-slate-700 rounded-xl shadow-md p-6 flex items-start">
                <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-500/10 flex items-center justify-center mr-4 flex-shrink-0">
              ...
              <div className="bg-white dark:bg-slate-800 dark:ring-1 dark:ring-slate-700 rounded-xl shadow-md p-6 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-slate-300">Athens, Greece</p>
                </div>
              </div>

              <div className="bg-white dark:bg-slate-800 dark:ring-1 dark:ring-slate-700 rounded-xl shadow-md p-6">
                <h3 className="font-bold text-gray-900 dark:text-white mb-3">Connect with me</h3>
